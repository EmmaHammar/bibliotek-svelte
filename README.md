...
# starta
projektet: npm run dev
kolla projektet: localhost:5000 (standard)
json-servern: localhost:3000/users (db)

# hur jag gjort: 
npx degit sveltejs/template helloSvelte
cd helloSvelte
npm install
code .
...
package.json mellan start och build:
    "dev": "run-p dev:client dev:server",
    "dev:client": "rollup -c -w",
    "dev:server": "json-server --watch db.json",

npm run dev -> ser mockup-endpoints
